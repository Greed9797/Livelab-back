...
CREATE INDEX IF NOT EXISTS idx_live_metric_revisions_live_em
  ON live_metric_revisions(live_id, alterado_em DESC);

-- vendas_atribuidas por status_aprovacao (pendentes — filtro mais comum)
